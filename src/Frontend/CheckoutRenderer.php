...
class CheckoutRenderer
{
			...
			foreach (array_keys($group_fields) as $key) {
				...
				if (! empty($ov['customer_types']) && is_array($ov['customer_types'])) {
					...
					if (! empty($allowed_types) && $is_post) {
						...
						$posted_type = isset($_POST['ca_customer_type'])
							? \sanitize_key(\wp_unslash((string) $_POST['ca_customer_type']))
							: '';
						...
						if (! $nonce_ok) {
							$wc_nonce = isset($_POST['woocommerce-process-checkout-nonce'])
								...
								: (isset($_POST['security']) ? \sanitize_text_field(\wp_unslash((string) $_POST['security'])) : '');
	...
	private function doFilterNativeFieldHtml(string $field_html, string $key, array $args, mixed $value): string
	{
		...
		$nonce           = isset($_POST['_ca_type_nonce'])
			? \sanitize_text_field(\wp_unslash((string) $_POST['_ca_type_nonce']))
			: (isset($_POST['nonce']) ? \sanitize_text_field(\wp_unslash((string) $_POST['nonce'])) : '');
		$posted_type  = ('' !== $nonce && \wp_verify_nonce($nonce, 'ca_set_type'))
			? (isset($_POST['ca_customer_type']) ? \sanitize_key(\wp_unslash((string) $_POST['ca_customer_type'])) : '')
			: '';
	...
	public function renderFieldsBeforeCheckoutForm(): void
	{
		$this->renderFieldsAtPosition('before_checkout_form');
	}
	public function renderFieldsBeforeCustomerDetails(): void
	{
		$this->renderFieldsAtPosition('before_customer_details');
	}
	public function renderFieldsBeforeBilling(): void
	{
		$this->renderFieldsAtPosition('before_billing');
	}
	public function renderFieldsInsideBilling(): void
	{
		$this->renderFieldsAtPosition('checkout_billing');
	}
	public function renderFieldsAfterBilling(): void
	{
		$this->renderFieldsAtPosition('after_billing');
	}
	public function renderFieldsBeforeShipping(): void
	{
		$this->renderFieldsAtPosition('before_shipping');
	}
	public function renderFieldsInsideShipping(): void
	{
		$this->renderFieldsAtPosition('checkout_shipping');
	}
	public function renderFieldsAfterShipping(): void
	{
		$this->renderFieldsAtPosition('after_shipping');
	}
	public function renderFieldsAfterCustomerDetails(): void
	{
		$this->renderFieldsAtPosition('after_customer_details');
	}
	public function renderFieldsBeforeOrderNotes(): void
	{
		$this->renderFieldsAtPosition('before_order_notes');
	}
	public function renderFieldsAfterOrderNotes(): void
	{
		$this->renderFieldsAtPosition('after_order_notes');
	}
	public function renderFieldsBeforeOrderReview(): void
	{
		$this->renderFieldsAtPosition('before_order_review');
	}
	public function renderFieldsInsideOrderReview(): void
	{
		$this->renderFieldsAtPosition('checkout_order_review');
	}
	public function renderFieldsAfterOrderReview(): void
	{
		$this->renderFieldsAtPosition('after_order_review');
	}
	public function renderFieldsAfterCheckoutForm(): void
	{
		$this->renderFieldsAtPosition('after_checkout_form');
	}
	...
	public function renderSectionsBeforeCheckoutForm(): void
	{
		$this->renderSections('before_checkout_form');
	}
	public function renderSectionsAfterCheckoutForm(): void
	{
		$this->renderSections('after_checkout_form');
	}
	public function renderSectionsBefore(): void
	{
		$this->renderSections('before_order_review');
	}
	public function renderSectionsAfter(): void
	{
		$this->renderSections('after_order_review');
	}
	public function renderSectionsBeforeBilling(): void
	{
		$this->renderSections('before_billing');
	}
	public function renderSectionsInsideBilling(): void
	{
		$this->renderSections('checkout_billing');
	}
	public function renderSectionsAfterBilling(): void
	{
		$this->renderSections('after_billing');
	}
	public function renderSectionsBeforeShipping(): void
	{
		$this->renderSections('before_shipping');
	}
	public function renderSectionsInsideShipping(): void
	{
		$this->renderSections('checkout_shipping');
	}
	public function renderSectionsAfterShipping(): void
	{
		$this->renderSections('after_shipping');
	}
	public function renderSectionsBeforeCustomerDetails(): void
	{
		$this->renderSections('before_customer_details');
	}
	public function renderSectionsAfterCustomerDetails(): void
	{
		$this->renderSections('after_customer_details');
	}
	public function renderSectionsBeforeOrderNotes(): void
	{
		$this->renderSections('before_order_notes');
	}
	public function renderSectionsAfterOrderNotes(): void
	{
		$this->renderSections('after_order_notes');
	}
	public function renderSectionsInsideOrderReview(): void
	{
		$this->renderSections('checkout_order_review');
	}
	...
	public function ajaxUpdateCartQty(): void
	{
		...
		$cart_item_key = isset($_POST['cart_item_key'])
			? \sanitize_text_field(\wp_unslash((string) $_POST['cart_item_key']))
			: '';
	...
	public function ajaxSetCustomerType(): void
	{
		...
		$type = isset($_POST['type'])
			? \sanitize_key(\wp_unslash((string) $_POST['type']))
			: (isset($_POST['value']) ? \sanitize_key(\wp_unslash((string) $_POST['value'])) : '');
		if ('' === $type) {
	...
	{
		$nonce_val = isset($_POST['_ca_type_nonce'])
			? \sanitize_text_field(\wp_unslash((string) $_POST['_ca_type_nonce']))
			: (isset($_POST['nonce']) ? \sanitize_text_field(\wp_unslash((string) $_POST['nonce'])) : '');
		$nonce_ok  = ('' !== $nonce_val) && \wp_verify_nonce($nonce_val, 'ca_set_type');
		...
		if ($nonce_ok && isset($_POST['post_data'])) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- post_data is a URL-encoded string; individual values are sanitized below.
