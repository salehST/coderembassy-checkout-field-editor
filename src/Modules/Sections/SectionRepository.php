<?php
namespace CoderEmbassy\CheckoutFieldEditor\Modules\Sections;
...
class SectionRepository extends AbstractRepository {
	public function __construct( \wpdb $db ) {
		...
		$this->table_name = $this->db->prefix . 'ca_sections';
	}
	...
	public function findById( int $id ): ?CA_Section {
		$model = parent::findById( $id );
		return $model instanceof CA_Section ? $model : null;
	}

	public function findByKey( string $key ): ?CA_Section {
	...
	public function save( mixed $entity ): int {
		if ( ! $entity instanceof CA_Section ) {
			throw new InvalidArgumentException( 'SectionRepository expects a CA_Section entity.' );
		}
	...
	protected function toModel( array $row ): CA_Section {
